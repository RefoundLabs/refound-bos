...
const DOC_SEPARATOR = ".";
const DEFAULT_TEMPLATE = "genwav.near/widget/templates.project.doc";
    ...
    const document = {
      ...
      [did]: {
        ...
        metadata: {
          ...
          type: "genwav.near/type/document",
        },
      },
    };
...
const handleProject = {
  getAll: () => {
    return getAllThings("genwav.near/type/project", [accountId]);
  },
  get: (pid) => {
  ...
  create: (project) => {
    ...
    Social.set({
      thing: createThing("genwav.near/type/project", {}, project),
    });
  },
  delete: (pid) => {
    Social.set({
