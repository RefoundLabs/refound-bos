...
const pages = [
  {
    ...
    widget: "genwav.near/widget/manager.index",
    provider: "genwav.near/widget/Provider",
  },
  {
    id: "editor",
    title: "Editor",
    active: state.page === "editor",
    widget: "genwav.near/widget/editor.index",
    provider: "genwav.near/widget/Provider",
  },
  {
    id: "manage",
    ...
    widget: "genwav.near/widget/project.index",
    provider: "genwav.near/widget/Provider",
  },
];
...
const navigate = (v, params) => {
  ...
  const url = Url.construct("#/genwav.near/widget/home", params);
  Storage.set("url", url);
};
        ...
        {activePage.provider ? (
          <Widget
            ...
            props={{
              ...
              ...props,
              templates: {
                Folders: "genwav.near/widget/editor.uiFolders",
              },
            }}
          />
        ) : (
