...
const DOC_SEPARATOR = ".";
const DEFAULT_TEMPLATE = "refound-campaign.near/widget/templates.project.doc";
    ...
    const document = {
      ...
      [did]: {
        ...
        metadata: {
          ...
          type: "refound-campaign.near/type/document",
        },
      },
    };
...
const handleProject = {
  getAll: () => {
    return getAllThings("refound-campaign.near/type/project", [accountId]);
  },
  get: (pid) => {
  ...
  create: (project) => {
    ...
    Social.set({
      thing: createThing("refound-campaign.near/type/project", {}, project),
    });
  },
  delete: (pid) => {
    Social.set({
