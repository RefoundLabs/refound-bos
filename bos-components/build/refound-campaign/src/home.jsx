...
const pages = [
  {
    ...
    widget: "refound-campaign.near/widget/manager.index",
    provider: "refound-campaign.near/widget/Provider",
  },
  {
    id: "editor",
    title: "Editor",
    active: state.page === "editor",
    widget: "refound-campaign.near/widget/editor.index",
    provider: "refound-campaign.near/widget/Provider",
  },
  {
    id: "manage",
    ...
    widget: "refound-campaign.near/widget/project.index",
    provider: "refound-campaign.near/widget/Provider",
  },
];
...
const navigate = (v, params) => {
  ...
  const url = Url.construct("#/refound-campaign.near/widget/home", params);
  Storage.set("url", url);
};
        ...
        {activePage.provider ? (
          <Widget
            ...
            props={{
              ...
              ...props,
              templates: {
                Folders: "refound-campaign.near/widget/editor.uiFolders",
              },
            }}
          />
        ) : (
