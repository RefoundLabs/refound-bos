...
const DOC_SEPARATOR = ".";
const DEFAULT_TEMPLATE = "refound-create-campaign.near/widget/templates.project.doc";
    ...
    const document = {
      ...
      [did]: {
        ...
        metadata: {
          ...
          type: "refound-create-campaign.near/type/document",
        },
      },
    };
...
const handleProject = {
  getAll: () => {
    return getAllThings("refound-create-campaign.near/type/project", [accountId]);
  },
  get: (pid) => {
  ...
  create: (project) => {
    ...
    Social.set({
      thing: createThing("refound-create-campaign.near/type/project", {}, project),
    });
  },
  delete: (pid) => {
    Social.set({
...
if (Storage.privateGet("debug")) {
  ...
  return (
    <>
      ...
      {/* <Widget
        src="<missingcode>/widget/Input.Select"
        props={{
          label: "Debug",
