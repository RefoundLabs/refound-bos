...
const pages = [
  {
    ...
    widget: "refound-create-campaign.near/widget/manager.index",
    provider: "refound-create-campaign.near/widget/Provider",
  },
  {
    id: "editor",
    title: "Editor",
    active: state.page === "editor",
    widget: "refound-create-campaign.near/widget/editor.index",
    provider: "refound-create-campaign.near/widget/Provider",
  },
  {
    id: "manage",
    ...
    widget: "refound-create-campaign.near/widget/project.index",
    provider: "refound-create-campaign.near/widget/Provider",
  },
];
...
const navigate = (v, params) => {
  ...
  const url = Url.construct("#/refound-create-campaign.near/widget/home", params);
  Storage.set("url", url);
};
        ...
        {activePage.provider ? (
          <Widget
            ...
            props={{
              ...
              ...props,
              templates: {
                Folders: "refound-create-campaign.near/widget/editor.uiFolders",
              },
            }}
          />
        ) : (
