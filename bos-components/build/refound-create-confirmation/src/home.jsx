...
const pages = [
  {
    ...
    widget: "refound-create-confirmation.near/widget/manager.index",
    provider: "refound-create-confirmation.near/widget/Provider",
  },
  {
    id: "editor",
    title: "Editor",
    active: state.page === "editor",
    widget: "refound-create-confirmation.near/widget/editor.index",
    provider: "refound-create-confirmation.near/widget/Provider",
  },
  {
    id: "manage",
    ...
    widget: "refound-create-confirmation.near/widget/project.index",
    provider: "refound-create-confirmation.near/widget/Provider",
  },
];
