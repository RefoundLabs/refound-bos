...
const DOC_SEPARATOR = ".";
const DEFAULT_TEMPLATE = "refound-create-post.near/widget/templates.project.doc";
    ...
    const document = {
      ...
      [did]: {
        ...
        metadata: {
          ...
          type: "refound-create-post.near/type/document",
        },
      },
    };
...
const handleProject = {
  getAll: () => {
    return getAllThings("refound-create-post.near/type/project", [accountId]);
  },
  get: (pid) => {
  ...
  create: (project) => {
    ...
    Social.set({
      thing: createThing("refound-create-post.near/type/project", {}, project),
    });
  },
  delete: (pid) => {
    Social.set({
