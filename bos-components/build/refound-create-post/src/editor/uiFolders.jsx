...
const renderFolder = (folder) => {
  ...
  return (
    ...
    >
      <Widget
        src="refound-create-post.near/widget/editor.uiFoldersMenu"
        props={{
          path,
          handler,
          renderTrigger: () =>
...
const renderProject = (project) => {
  ...
  return (
    <Project>
      <a
        target="_blank"
        href={Url.construct("#/refound-create-post.near/widget/p", {
          id: projectId,
      ...
      <div>
        <a
          ...
          href={Url.construct("#/refound-create-post.near/widget/home", {
            page: "manage",
            project: projectId,
          })}
        >
