...
const DOC_SEPARATOR = ".";
const DEFAULT_TEMPLATE = "refound-features.near/widget/templates.project.doc";
    ...
    const document = {
      ...
      [did]: {
        ...
        metadata: {
          ...
          type: "refound-features.near/type/document",
        },
      },
    };
...
const handleProject = {
  getAll: () => {
    return getAllThings("refound-features.near/type/project", [accountId]);
  },
  get: (pid) => {
  ...
  create: (project) => {
    ...
    Social.set({
      thing: createThing("refound-features.near/type/project", {}, project),
    });
  },
  delete: (pid) => {
    Social.set({
