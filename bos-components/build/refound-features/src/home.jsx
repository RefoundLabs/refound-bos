...
const pages = [
  {
    ...
    widget: "refound-features.near/widget/manager.index",
    provider: "refound-features.near/widget/Provider",
  },
  {
    id: "editor",
    title: "Editor",
    active: state.page === "editor",
    widget: "refound-features.near/widget/editor.index",
    provider: "refound-features.near/widget/Provider",
  },
  {
    id: "manage",
    ...
    widget: "refound-features.near/widget/project.index",
    provider: "refound-features.near/widget/Provider",
  },
];
...
const navigate = (v, params) => {
  ...
  const url = Url.construct("#/refound-features.near/widget/home", params);
  Storage.set("url", url);
};
        ...
        {activePage.provider ? (
          <Widget
            ...
            props={{
              ...
              ...props,
              templates: {
                Folders: "refound-features.near/widget/editor.uiFolders",
              },
            }}
          />
        ) : (
