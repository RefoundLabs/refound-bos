...
const DOC_SEPARATOR = ".";
const DEFAULT_TEMPLATE = "refound-landing.near/widget/templates.project.doc";
    ...
    const document = {
      ...
      [did]: {
        ...
        metadata: {
          ...
          type: "refound-landing.near/type/document",
        },
      },
    };
...
const handleProject = {
  getAll: () => {
    return getAllThings("refound-landing.near/type/project", [accountId]);
  },
  get: (pid) => {
  ...
  create: (project) => {
    ...
    Social.set({
      thing: createThing("refound-landing.near/type/project", {}, project),
    });
  },
  delete: (pid) => {
    Social.set({
