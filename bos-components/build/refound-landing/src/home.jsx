...
const pages = [
  {
    ...
    widget: "refound-landing.near/widget/manager.index",
    provider: "refound-landing.near/widget/Provider",
  },
  {
    id: "editor",
    title: "Editor",
    active: state.page === "editor",
    widget: "refound-landing.near/widget/editor.index",
    provider: "refound-landing.near/widget/Provider",
  },
  {
    id: "manage",
    ...
    widget: "refound-landing.near/widget/project.index",
    provider: "refound-landing.near/widget/Provider",
  },
];
...
const navigate = (v, params) => {
  ...
  const url = Url.construct("#/refound-landing.near/widget/home", params);
  Storage.set("url", url);
};
        ...
        {activePage.provider ? (
          <Widget
            ...
            props={{
              ...
              ...props,
              templates: {
                Folders: "refound-landing.near/widget/editor.uiFolders",
              },
            }}
          />
        ) : (
