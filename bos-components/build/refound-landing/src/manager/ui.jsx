...
return (
  <div style={{backgroundColor:"#BFE7B5", color:"#113F0D", minHeight:'100vh', overflow:"hidden"}}>
    {(
      ...
      <div className="text-left row bg-white" style={{minHeight:"100vh", paddingTop:"25%"}}>
        <div className="col">
          <h3>Who Are We <b>Building</b> for?</h3>
          <div style={{border:"2px solid #50493F", borderRadius:"45px", padding:"20px"}}>
            <div>
      ...
      <div className="text-left row" style={{minHeight:"100vh", paddingTop:"25%", backgroundColor:"#060A2D", color:"#2E34B2"}}>
        <div className="col">
          <h3>Use <b>Cases</b></h3>
