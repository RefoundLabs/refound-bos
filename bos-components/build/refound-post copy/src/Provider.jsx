...
const DEFAULT_TEMPLATE =
  "refound-create-success.near/widget/templates.project.doc";
...
const handleProject = {
  getAll: () => {
    return getAllThings("refound-create-success.near/type/project", [
      accountId,
    ]);
  },
  get: (pid) => {
  ...
  create: (project) => {
    ...
    Social.set({
      thing: createThing(
        "refound-create-success.near/type/project",
        {},
        project,
      ),
    });
