...
const DOC_SEPARATOR = ".";
const DEFAULT_TEMPLATE = "refound-post.near/widget/templates.project.doc";
    ...
    const document = {
      ...
      [did]: {
        ...
        metadata: {
          ...
          type: "refound-post.near/type/document",
        },
      },
    };
...
const handleProject = {
  getAll: () => {
    return getAllThings("refound-post.near/type/project", [accountId]);
  },
  get: (pid) => {
  ...
  create: (project) => {
    ...
    Social.set({
      thing: createThing("refound-post.near/type/project", {}, project),
    });
  },
  delete: (pid) => {
    Social.set({
