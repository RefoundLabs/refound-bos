...
const pages = [
  {
    ...
    widget: "refound-post.near/widget/manager.index",
    provider: "refound-post.near/widget/Provider",
  },
  {
    id: "editor",
    title: "Editor",
    active: state.page === "editor",
    widget: "refound-post.near/widget/editor.index",
    provider: "refound-post.near/widget/Provider",
  },
  {
    id: "manage",
    ...
    widget: "refound-post.near/widget/project.index",
    provider: "refound-post.near/widget/Provider",
  },
];
...
const navigate = (v, params) => {
  ...
  const url = Url.construct("#/refound-post.near/widget/home", params);
  Storage.set("url", url);
};
        ...
        {activePage.provider ? (
          <Widget
            ...
            props={{
              ...
              ...props,
              templates: {
                Folders: "refound-post.near/widget/editor.uiFolders",
              },
            }}
          />
        ) : (
