...
import type { EventEmitterService, LoggerService, ProviderService, JsonStorageService } from "../services";
...
export declare type InstantLinkWalletMetadata = BaseWalletMetadata & {
    contractId: string;
    runOnStartup: boolean;
};
export declare type InstantLinkWalletBehaviour = BaseWalletBehaviour & {
    getContractId(): string;
};
export declare type InstantLinkWallet = BaseWallet<"instant-link", InstantLinkWalletMetadata, InstantLinkWalletBehaviour>;
...
export declare type BridgeWalletBehaviour = Modify<BaseWalletBehaviour, {
...
export declare type WalletMetadata = BrowserWalletMetadata | InjectedWalletMetadata | InstantLinkWalletMetadata | HardwareWalletMetadata | BridgeWalletMetadata;
export declare type Wallet = BrowserWallet | InjectedWallet | InstantLinkWallet | HardwareWallet | BridgeWallet;
