...
var core = require('@here-wallet/core');
...
const initHereWallet = config => __awaiter(void 0, void 0, void 0, function* () {
  ...
  const here = new core.HereWallet({
  ...
  return {
    ...
    verifyOwner() {
      return __awaiter(this, void 0, void 0, function* () {
        throw Error("HereWallet:verifyOwner is deprecated, use signMessage method with impletementation NEP0413 Standart");
      });
    },
